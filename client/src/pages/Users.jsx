...
const Users = () => {
  ...
  const TableRow = ({ user }) => (
    <tr className='border-b bg-white border-gray-200 text-grey-900 hover:bg-gray-100/10'>
      <td className='p-2'>
        <div className='flex items-center gap-3'>
          <div className='w-9 h-9 rounded-full flex items-center justify-center text-sm bg-pink-500'>
